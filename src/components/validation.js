...
const resetInputValidation = (formElement, inputElement, config) => {
  inputElement.setCustomValidity('');
  if (inputElement.value.trim() !== '' && !inputElement.validity.valid) {
...
export const clearValidation = (formElement, config) => {
  ...
  inputList.forEach((inputElement) => {
    resetInputValidation(formElement, inputElement, config);
  });
